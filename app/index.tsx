...
import { Text, View, StyleSheet, FlatList, Dimensions, TouchableOpacity, Modal, ScrollView, SafeAreaView, StatusBar } from "react-native";
    ...
    try {
      ...
      const sampleCves = [
        ...
        },
        {
          ...
          "source": "Source: NIST",
          "summary": "A vulnerability in XYZ software allows remote attackers to bypass authentication and gain access to sensitive data. The issue affects versions prior to 2.3.4 and has been patched in version 2.3.5.",
        ...
        },
        {
          ...
          "source": "Source: MITRE",
          "summary": "An SQL injection vulnerability in the login module of ABC web application allows attackers to execute arbitrary SQL queries, potentially leading to unauthorized access. The issue is resolved in patch v1.5.7.",
        ...
        },
        {
          ...
          "summary": "An insecure deserialization vulnerability in the XYZ service allows remote attackers to execute arbitrary code, which could lead to a complete system compromise. The issue was patched in version 3.2.1.",
        ...
        },
        {
          ...
          "summary": "A critical vulnerability in the PQR application allows remote attackers to execute arbitrary commands on vulnerable systems. The flaw was patched in version 1.2.3.",
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={[styles.text, { paddingHorizontal: 30 }]}>Your Website</Text>
          ...
          <View style={styles.dropdownContainer}>
            ...
            >
              <Text style={styles.dropdownButtonText}>{getActiveFilterLabel()}</Text>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>No vulnerabilities found for {getActiveFilterLabel()}</Text>
              </View>
            }
            accessible={true}
