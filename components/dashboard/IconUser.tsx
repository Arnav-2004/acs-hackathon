...
export function IconsUser() {
  return (
    <Svg
      width={33} // 22 * 1.5 to account for the scale transform
      height={33} // 22 * 1.5 to account for the scale transform
      viewBox="0 0 22 22"
      fill="none"
    >
      <Path
      ...
      <Path
        ...
        fill="url(#paint1_linear_6_166)"
      />
      <Defs>
        <LinearGradient
          id="paint0_linear_6_166"
          x1={11}
          y1={4}
          x2={11}
          y2={12}
